...
posterior4 <- dgamma(theta,alpha+sum(y.new),beta+n.new)
...
plot(theta,posterior4,,type="l",xlab="theta",ylab="Posterior density",ylim=c(0,1),xlim=c(0,10))
lines(theta,posterior3,col="red",lty=2)
